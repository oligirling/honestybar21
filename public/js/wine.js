...
{
    $('.drink').addClass('glass-animation')
    $('.wine-glass').addClass('glass-animation')
    $('.wine').addClass('wine-animation')
    $('.wine-pipe').addClass('wine-pipe-animation')
    $('.pipe-handle').addClass('pipe-handle-animation')
    $('.bubble1').addClass('bubble1-animation')
    $('.bubble2').addClass('bubble2-animation')
    $('.bubble3').addClass('bubble3-animation')
    $('.bubble4').addClass('bubble4-animation')
}
